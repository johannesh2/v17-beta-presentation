...
export class MainEndpoint extends LitElement {
  ...
  @property({ type: Array }) menuTabs: MenuTab[] = [
    ...
    {route: 'dataprovider', name: 'Data Provider'},
    ...
    return html`
      <vaadin-app-layout primary-section="drawer">
        <header slot="navbar" theme="dark">
          ...
          <img src="images/face.jpg" alt="Avatar" />
        </header>

        <div slot="drawer">
          <div id="logo">
            <img src="images/logos/vaadin.png" alt="${this.projectName} logo" />
